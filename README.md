...
#### How will you fix it?
To solve This through research i found that Java has Math class called BigDecimal that for this cases when working with floats and to transform base 10 and binary numbers its more precise.
